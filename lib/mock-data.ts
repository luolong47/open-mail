...
export const mockEmails: Email[] = [
  ...
  },
  {
    ...
    snippet: 'Microsoft 帐户 新应用有权访问你的数据 remotely-save 已连接到 Microsoft 帐户 hello@openmail.com。 如果未授予此访问权限，请...',
    body: 'Microsoft 帐户\n\n新应用有权访问你的数据\nremotely-save 已连接到 Microsoft 帐户 hello@openmail.com。\n\n如果未授予此访问权限，请立即检查你的活动。',
    date: '4/6',
    read: true,
    starred: false,
    hasAttachment: false,
  ...
  },
  {
    ...
    senderEmail: '8657838@bank-of-china.com',
    subject: '回复：test.7z',
    snippet: '666 hello@openmail.com 原始邮件 发件人：Antigravity <admin@openmail.com> 发件时...',
    body: '666\n\nhello@openmail.com\n\n原始邮件\n发件人：Antigravity <admin@openmail.com>\n发件时间：...',
    date: '刚刚',
    read: true,
    starred: false,
    hasAttachment: false,
